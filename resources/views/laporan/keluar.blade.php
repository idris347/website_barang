...
<h4 class="page-title text-white mt-2"><i class="fas fa-clone mr-2 fa-3x"></i>Data Keluar Barang</h4>
...
<div class="row">
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="my-2">
                    <form action="{{ route('laporan_keluar') }}" method="GET">
        ...
        <div class="card">
            <div class="card-body">
                <div class="table-responsive">
                    <div class="col-md-6">
                        <form action="{{ route('cetak2') }}" method="GET" target="_blank">
